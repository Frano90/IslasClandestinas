...
Shader "GlassDistanceBased"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_Float0("Float 0", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_12_0 = distance( WorldPosition , _WorldSpaceCameraPos );
				...
				float Occlusion = 1;
				float Alpha = saturate( ( temp_output_12_0 * _Float0 ) );
...
/*ASEBEGIN
Version=18900
2069;21;1592;945;1334.969;282.1844;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-880,368;Inherit;False;Property;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0;0.2220093;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-512,112;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;16;-256,112;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;13;-473,-37;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=32BEE082ED96B6B4AB7230D7341411551F02D59B